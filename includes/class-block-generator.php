...
class AI_Block_Generator
{
    ...
    3. $slug.php - Main template file
       ...
       - also add the css  in the style tag and js script in the script tag in template file
        CSS styles
       ...
       - Must use vanilla JavaScript (add cdn link if adding jQuery or anyother js/ui lib)
    ...
    private function parse_ai_response($response, $slug)
    {
        ...
        for ($i = 0; $i < count($sections); $i += 2) {
            ...
            $remove = ["```php", "```json", "```css", "```js", "```javascript", "```JavaScript", "```Javascript", "```"];
